$(function () {
    ...
    $("#jsGrid").jsGrid({
        ...
        fields: [
            ...
            { name: "vessel_id", type: "select", title: "Vessel", items: countries, valueField: "Id", textField: "Name" },
            ...
            { name: "product_id", type: "select", title: "Product", items: products, valueField: "Id", textField: "Name" },
